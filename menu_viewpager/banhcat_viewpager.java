...
public class banhcat_viewpager extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.layout_banhcat,container,false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final String[] title =new String[]{"Cookies","Cupcake","Doughnut"};
        ...
        FragmentPagerAdapter fAdapter=new FragmentPagerAdapter(getActivity().getSupportFragmentManager()) {
            ...
            public Fragment getItem(int i) {
                if (i==0){
                    return main_recycv_home.getType("cookie");
                }
                else if(i==1){
                    return main_recycv_home.getType("cupcake");

                }
                else if (i==2){
                    return main_recycv_home.getType("doughnut");
